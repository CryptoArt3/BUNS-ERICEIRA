...
const FROZEN_BUNANA_SLIDES: FrozenBunanaSlide[] = [
  {
    ...
    price: "3.00€",
    lines: [
      "Chocolate Callebaut B823 (leite)",
  ...
  },
  {
    ...
    price: "3.50€",
    lines: [
      "Chocolate branco ou leite",
      "1 topping crocante",
      "1 topping em bisnaga",
    ],
    punchline: "BUILD YOUR OWN BRAIN FREEZE.",
    accent: "ice",
    durationMs: 7000,
  },
];
