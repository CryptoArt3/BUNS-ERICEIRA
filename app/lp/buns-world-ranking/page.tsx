    ...
    <main className="min-h-screen bg-[#050404] text-stone-50">
      ...
      <section className="relative mx-auto flex min-h-screen max-w-5xl flex-col justify-center gap-10 px-6 py-16 sm:px-10">
        <div className="space-y-4">
          <p className="inline-flex rounded-sm border border-[#00f0ff]/55 bg-[#00f0ff]/10 px-4 py-1.5 text-[0.68rem] font-black uppercase tracking-[0.42em] text-[#00f0ff] shadow-[0_0_18px_rgba(0,240,255,0.22),0_8px_24px_rgba(0,0,0,0.5)]">
            Season Live
          </p>
          ...
          <p className="max-w-3xl text-lg uppercase tracking-[0.1em] text-[#b8ad94] sm:text-xl">
            {bunsWorldRankingPoll.subheadline}
          </p>
        </div>
