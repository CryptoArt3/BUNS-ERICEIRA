  ...
  slides: [
    {
      ...
      campaign_id: "buns-adventures",
      product_slug: "buns_adventures",
      headline: "BUNS ADVENTURES",
      subheadline: "ERICEIRA STORIES",
      cta: "Scan to follow the story",
      duration: 30,
      image: null,
      episode_id: "episode-01",
      episode_number: "01",
      episode_name: "Jogo da Bola",
      video_src: "/videos/buns-episode-01.mp4?v=adventures-v1",
    },
  ],
};
